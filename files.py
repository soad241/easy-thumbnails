...
from main.storage import FTPStorageFile
...
class Thumbnailer(FTPStorageFile):
    """
    ...
    def __init__(self, file, name=None, source_storage=None,
        ...
        super(Thumbnailer, self).__init__(file, name, 'rw')
        self.source_storage = source_storage or default_storage
        self.source_storage = DEFAULT_THUMBNAIL_STORAGE
        self.thumbnail_storage = DEFAULT_THUMBNAIL_STORAGE
...
class ThumbnailerFieldFile(FieldFile, Thumbnailer):
    ...
    def save(self, name, content, *args, **kwargs):
        ...
        """
        super(ThumbnailerFieldFile, self).save(name, content, *args,
                                               **kwargs)
